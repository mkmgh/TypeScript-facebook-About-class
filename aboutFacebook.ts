class AboutClass{
    ...
    constructor(public workAt:string, public collegeName: string, public schoolName: string, public livesIn:string, public contactNumber: number, public age:number, public emailID:string, public DOB:string, public gender:string, public language:string, public relationshipStatus:string, public nickname:string, public fevQuote:string, public numberOfFriends:number){
...
let aboutObject= new AboutClass("IBM India Pvt. Ltd.","SGGS College of Engineering","P. N. College","Pusad",7777777777,23,"mayurmahamune7@gmail.com","12 Feb 1995","Male","English, Hindi and MArathi","single","Myu","Work hard and stay humble",1050);
